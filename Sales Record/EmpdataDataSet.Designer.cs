...
namespace Sales_Record {
    ...
    public partial class EmpdataDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(int Emp_id, string Emp_Name, int Emp_Salary, string Designation, string Status) {
...
namespace Sales_Record.EmpdataDataSetTableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([Emp_id] = @Original_Emp_id) AND ((@IsNull_Emp_Name = 1 AND [Emp_Name] IS NULL) OR ([Emp_Name] = @Original_Emp_Name)) AND ((@IsNull_Emp_Salary = 1 AND [Emp_Salary] IS NULL) OR ([Emp_Salary] = @Original_Emp_Salary)) AND ((@IsNull_Designation = 1 AND [Designation] IS NULL) OR ([Designation] = @Original_Designation)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([Emp_id], [Emp_Name], [Emp_Salary], [Designation]," +
                " [Status]) VALUES (@Emp_id, @Emp_Name, @Emp_Salary, @Designation, @Status);\r\nSEL" +
                "ECT Emp_id, Emp_Name, Emp_Salary, Designation, Status FROM Employees WHERE (Emp_" +
                "id = @Emp_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [Emp_id] = @Emp_id, [Emp_Name] = @Emp_Name, [Emp_Salary] = @Emp_Salary, [Designation] = @Designation, [Status] = @Status WHERE (([Emp_id] = @Original_Emp_id) AND ((@IsNull_Emp_Name = 1 AND [Emp_Name] IS NULL) OR ([Emp_Name] = @Original_Emp_Name)) AND ((@IsNull_Emp_Salary = 1 AND [Emp_Salary] IS NULL) OR ([Emp_Salary] = @Original_Emp_Salary)) AND ((@IsNull_Designation = 1 AND [Designation] IS NULL) OR ([Designation] = @Original_Designation)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT Emp_id, Emp_Name, Emp_Salary, Designation, Status FROM Employees WHERE (Emp_id = @Emp_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Sales_Record.Properties.Settings.Default.EmpdataConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Emp_id, Emp_Name, Emp_Salary, Designation, Status FROM dbo.Employees";
        ...
        public virtual int Fill(EmpdataDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual EmpdataDataSet.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EmpdataDataSet.EmployeesDataTable dataTable = new EmpdataDataSet.EmployeesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EmpdataDataSet.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Emp_id, string Original_Emp_Name, global::System.Nullable<int> Original_Emp_Salary, string Original_Designation, string Original_Status) {
            ...
            if ((Original_Emp_Salary.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_Emp_Salary.Value));
            }
            else {
        ...
        public virtual int Insert(int Emp_id, string Emp_Name, global::System.Nullable<int> Emp_Salary, string Designation, string Status) {
            ...
            if ((Emp_Salary.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((int)(Emp_Salary.Value));
            }
            else {
        ...
        public virtual int Update(int Emp_id, string Emp_Name, global::System.Nullable<int> Emp_Salary, string Designation, string Status, int Original_Emp_id, string Original_Emp_Name, global::System.Nullable<int> Original_Emp_Salary, string Original_Designation, string Original_Status) {
            ...
            if ((Emp_Salary.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Emp_Salary.Value));
            }
            else {
            ...
            if ((Original_Emp_Salary.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_Emp_Salary.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Emp_Name, global::System.Nullable<int> Emp_Salary, string Designation, string Status, int Original_Emp_id, string Original_Emp_Name, global::System.Nullable<int> Original_Emp_Salary, string Original_Designation, string Original_Status) {
            return this.Update(Original_Emp_id, Emp_Name, Emp_Salary, Designation, Status, Original_Emp_id, Original_Emp_Name, Original_Emp_Salary, Original_Designation, Original_Status);
        }
    }
